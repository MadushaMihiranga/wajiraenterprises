...
function fillTable(tableid,obs,modifyFunction=null){
    ...
    for(var i=0; i<obs.length; i++){
        ...
        if(hasButton){
            ...
            //button.setAttribute('onclick','fillForm('+i+')');   data-toggle="tooltip" data-placement="top" title="Update Selected Employee" input.setAttribute('type','text');
            button.setAttribute('type','button');
            button.classList.add('btn');
            button.classList.add('btn-sm');
            button.classList.add('btn-secondary');
            button.classList.add('btn-table-edit');
            button.innerHTML = '<i class="fal fa-file-edit"></i>';
            button.setAttribute('data-toggle',"tooltip");
            button.setAttribute('data-placement',"right");
            button.setAttribute('title',"Edit Detail");
           /* button.data-toggle="tooltip";
            button.data-placement='right';
            button.title='Edit Detail';*/
...
function selectRow(tableid,rowno,active){
    var rows = tableid.children[1].children;
    rows[rowno-1].style.color="#FF6347";
    //rows[rowno-1].style.border="2px solid #FF6347";
    //rows[rowno-1].style.fontWeight="bold";
}
...
function fillCmb(combo,message,list,selectedvalue) {
    ...
    for (index in  list) {
        ...
        var text = document.createTextNode(list[index]);
...
function checkBox(parent,id,lblText,def,ob,prop,oldob){
    ...
    var formCheck = createElement('div',id+'FormCheck');
    ...
    var lable = createElement('lable',id+'Lable');
    lable.classList.add('form-check-label');
    lable.for = id;
    lable.innerHTML=" "+lblText;

    formCheck.appendChild(field);
    formCheck.appendChild(lable);
    ...
    field.onchange = function(){
        ...
        if (this.checked) {
            ob[prop] = 1;
            if (oldob != null && oldob[prop] != ob[prop]){
                this.parentNode.style.color = updated;
            }else{
                this.parentNode.style.color = valid;
             }
        }
        else {
            ob[prop] = 0;
...
function fileChooser(parent,id,lblText,labelWidth,extenstions,maxsize,required,ob,prop,oldob){
    ...
    var formGroup = createElement('div',id+'FormGroup');
    var label = createElement('label',id+'Label');
    formGroup.classList.add('form-control-file');
    //label.innerHTML = lblText;
    label.for = id;
    label.classList.add('control-label');
    label.classList.add('col-md-'+labelWidth);
    ...
    fieldButton.classList.add('btn-outline-secondary');
    fieldButton.innerHTML = '<i class="fal fa-camera-alt"></i> &nbsp;Select a '+lblText;
    ...
    fieldButtonC.classList.add('btn-outline-secondary');
...
/*function toast(title,message) {
    ...
    card.classList.add('toast-header');

    var cardheader = document.createElement('div');
    cardheader.classList.add('card-header');
    cardheader.classList.add('toast-header');
    cardheader.innerText = title;


    var cardbody = document.createElement('div');
    cardbody.classList.add('card-body');
    cardbody.classList.add('toast-body');

    var row = document.createElement('div');
    row.classList.add('row');
    var msgArea = document.createElement('div');
    msgArea.classList.add('col-md-10');
    msgArea.classList.add('toast-message-area{');
    message.innerHTML=message;
    var iconArea = document.createElement('div');
    iconArea.classList.add('col-md-2');
    iconArea.innerHTML='<i class="fas fa-check-circle" style="color: #28a745">';

    row.appendChild(msgArea);
    ...
    for(var i=0; i<obs.length; i++){
        ...
        if(hasButton){
         ...
         /*   $(function () {
            ...
            button.classList.add('btn-sm');
            button.classList.add('btn-secondary');
            button.innerHTML = '<i class="fal fa-minus-circle"></i>';
...
function listTransfer(parent,id,lblText,labelWidth,ob,oldob,prop,otherAssociation,visibleProp='name'){
   ...
   // innerRow.classList.add('text-center');
    ...
    btnRight.classList.add('btn-listTransfer');
    btnRight.setAttribute('type','button');
    //btnRight.setAttribute('onclick','return false');

    var btnRightAll = createElement('button');
    btnRightAll.innerHTML='<i class="fas fa-chevron-double-right"></i>';
    ...
    btnRightAll.classList.add('btn-listTransfer');
    btnRightAll.setAttribute('type','button');
    //btnRightAll.setAttribute('onclick','return false');

    var btnLeftAll = createElement('button');
    btnLeftAll.innerHTML='<i class="fas fa-chevron-double-left"></i>';
    ...
    btnLeftAll.classList.add('btn-listTransfer');
    btnLeftAll.setAttribute('type','button');
    //btnLeftAll.setAttribute('onclick','return false');
    ...
    btnLeft.classList.add('btn-listTransfer');
    btnLeft.setAttribute('type','button');
   // btnLeft.setAttribute('onclick','return false');
    ...
    //fieldRight.classList.add('wrapinput');
    fieldRight.classList.add('txtinput');
    ...
    fieldRight.style.height='180px';
    fieldRight.style.width='135px';
   ...
   // formGroup.classList.add('text-center');
    formGroup.appendChild(label);
    formGroup.appendChild(fieldArea);
    parent.appendChild(formGroup);
...
function listTransferHorizontal(parent,id,lblText,labelWidth,ob,oldob,prop,otherAssociation,visibleProp='name'){
    var parent = document.getElementById(parent);
    var formGroup = createElement('div',id+'FormGroup');
    var label = createElement('label',id+'Label');
    label.innerHTML = lblText;
    ...
    var upperRow = createElement('div');
    upperRow.classList.add('row');

    var middleRow = createElement('div');
    middleRow.classList.add('row');

    var lowerRow = createElement('div');
  ...
  /*  var cell1 = createElement('div');
    ...
    fieldLeft.classList.add('txtinput');
    fieldLeft.setAttribute('data-right_id',id);
    fieldLeft.style.height='120px';
    fieldLeft.style.width='95%';
    fieldLeft.style.marginLeft='15px';
    fieldLeft.style.marginBottom='4px';
    upperRow.appendChild(fieldLeft);
  ...
  /*  var cell2 = createElement('div');
    ...
    var btnRight = createElement('button');
    btnRight.innerHTML='Add <i class="far fa-chevron-down"></i>';
    btnRight.classList.add('btn');
    btnRight.classList.add('btn-default');
    btnRight.classList.add('btn-xs');
    btnRight.classList.add('btn-block');
    btnRight.classList.add('btn-listTransfer');
    btnRight.setAttribute('type','button');
    var col1 = createElement('div');
    col1.classList.add('col-md-3');
    col1.style.paddingLeft = '15px';
    col1.style.paddingRight = '1px';
    col1.appendChild(btnRight);
    //btnRight.setAttribute('onclick','return false');

    var btnRightAll = createElement('button');
    btnRightAll.innerHTML='Add All <i class="far fa-chevron-double-down"></i>';
    btnRightAll.classList.add('btn');
    btnRightAll.classList.add('btn-default');
    btnRightAll.classList.add('btn-xs');
    btnRightAll.classList.add('btn-block');
    btnRightAll.classList.add('btn-listTransfer');
    btnRightAll.setAttribute('type','button');
    var col2 = createElement('div');
    col2.classList.add('col-md-3');
    col2.style.paddingLeft = '1px';
    col2.style.paddingRight = '1px';
    col2.appendChild(btnRightAll);
    //btnRightAll.setAttribute('onclick','return false');

    var btnLeftAll = createElement('button');
    btnLeftAll.innerHTML='Remove All <i class="far fa-chevron-double-up"></i>';
    btnLeftAll.classList.add('btn');
    btnLeftAll.classList.add('btn-default');
    btnLeftAll.classList.add('btn-xs');
    btnLeftAll.classList.add('btn-block');
    ...
    col3.style.paddingLeft = '1px';
    col3.style.paddingRight = '1px';
    col3.appendChild(btnLeftAll);
    //btnLeftAll.setAttribute('onclick','return false');

    var btnLeft = createElement('button');
    btnLeft.innerHTML='Remove <i class="far fa-chevron-up"></i>';
    btnLeft.classList.add('btn');
    btnLeft.classList.add('btn-default');
    btnLeft.classList.add('btn-xs');
    btnLeft.classList.add('btn-block');
    btnLeft.classList.add('btn-listTransfer');
    btnLeft.setAttribute('type','button');
    var col4 = createElement('div');
    col4.classList.add('col-md-3');
    col4.style.paddingLeft = '1px';
    col4.style.paddingRight = '15px';
    col4.appendChild(btnLeft);
    // btnLeft.setAttribute('onclick','return false');

    middleRow.appendChild(col1);
    middleRow.appendChild(col2);
    middleRow.appendChild(col3);
    middleRow.appendChild(col4);
    ...
    fieldRight.setAttribute('data-visibleProp',visibleProp);
    fieldRight.setAttribute('data-oldobject',oldob);
    fieldRight.style.height='120px';
    fieldRight.style.width='95%';
    fieldRight.style.marginLeft='15px';
    fieldRight.style.marginTop='4px';

    lowerRow.appendChild(fieldRight);

    /*innerRow.appendChild(upperRow);
    innerRow.appendChild(middleRow);
    innerRow.appendChild(lowerRow);*/

    fieldArea.appendChild(upperRow);
    fieldArea.appendChild(middleRow);
    fieldArea.appendChild(lowerRow);
    formGroup.classList.add('wrapinput');
    // formGroup.classList.add('text-center');
    formGroup.appendChild(label);
    formGroup.appendChild(fieldArea);
...
function listTransferSetStyle(id){
    ...
    if (rightField.children.length == 0) {
        rightField.style.borderColor = initial;
    }
    else {
        rightField.style.borderColor = valid;
    }
    if (oldob != null) {
        if (isEqual(ob[obprop],oldob[obprop],otherAssociation))
            rightField.style.borderColor = updated;
    }
...
function printForm(id){
    ...
    var divs = form.children;
    for(var i=0; i<divs.length; i++){
        var div = divs[i];
        if(div.hasAttribute("fieldType")){
            var type = div.getAttribute("fieldType");
            var label="";
            var data="";
            switch (type){
                case "textField":
                    label = div.firstChild.innerHTML;
                    data = div.lastChild.firstChild.value;
                    break;
                case "combo":
                    label = div.firstChild.innerHTML;
                    data = div.lastChild.firstChild.selectedOptions[0].innerHTML;
                    break;
                case "fileChooser":
                    label = div.firstChild.innerHTML;
                    var imgs = div.lastChild.getElementsByTagName("img");
    ...
    var newWin=window.open('a','Print-Window');
...
function printTable(id){
    var table = document.createElement("table");
    var srcTable = document.getElementById(id).cloneNode(true);

    table.classList.add("table");
    table.classList.add("table-striped");
    table.classList.add("table-condensed");

    var headingRow = srcTable.children[0].children[0];
    var dataRows = srcTable.children[1].children;
    ...
    var newWin=window.open('a','Print-Window');
    newWin.document.open();
    newWin.document.write("<html><head><link rel='stylesheet' href='../plugin/bootstrap/css/bootstrap.min.css'/></head><body style='margin-top: 200px; margin-right: 50px;margin-left: 50px;'>"+table.outerHTML+"</body></html>");
    setTimeout(function () {
        newWin.print();
    },100)
}
...
/*
function printForm(title,data,format=null){
    if(format==null){ }
    ...
    var table = document.createElement("table");
    var divs = form.children;
    alert("la"+divs.length);
    for(var i=0; i<divs.length; i++){

        var div = divs[i];
        window.alert(divs[i].innerHTML);
        if(div.hasAttribute("fieldType")){
            window.alert("tttttt");
            var type = div.getAttribute("fieldType");
            var label="";
    ...
    *!/
    ...
    var format ="<table class='table table-striped'><thead><tr><td>Title</td></tr></thead><tbody><tr>Name<td></td><td>Suranga</td></tr><tr>Age<td></td><td>38</td></tr></tbody></tbody></thead></table>";
    var newWin=window.open('a','Print-Window');
    newWin.document.open();
    newWin.document.write("<html><head><link rel='stylesheet' href='../plugin/bootstrap/css/bootstrap.min.css'/></head><body>"+format+"</body></html>");
    setTimeout(function () {
        newWin.print();
    },100)
}

function printTable(tableid,title,tablewidth,removecolsdecorder){
    var table = document.createElement("table");
    var srcTable = document.getElementById(tableid).cloneNode(true);
    ...
    for(var i=0; i<removecolsdecorder.length; i++){
        headingRow.removeChild(headingRow.children[removecolsdecorder[i]]);
    }
    ...
    for(var i=0; i<dataRows.length; i++){
        ...
        for(var j=0; j<removecolsdecorder.length; j++){
            row.removeChild(row.children[removecolsdecorder[j]]);
        }
    ...
    var format = table.outerHTML;

    var newwindow=window.open();
    newwindow.document.write("<html><head><link rel='stylesheet' href='../plugin/bootstrap/css/bootstrap.min.css'/></head><body>"+title+format+"</body></html>");
...
function printDiv(divid,width,height,topoffset,image){
    ...
    newwindow.document.write("" +
        ...
        "</head>" +
        "<body>" +
        "<div style='width: "+width+"px; height: "+height+"px;'>"+format+"</div>" +
        "</body>" +
        "</html>");
    setTimeout(function () {newwindow.print(); newwindow.close();},100) ;
