...
function listCompera(list1,list2,atb1,atb2='name',atb3) {
    var props = ['id', atb2,atb3];
...
function httpRequestwithoutlist(url,method,data){

    var ajax = new XMLHttpRequest();
    ajax.open(method, url, false);
    ajax.setRequestHeader("Content-type", "application/json");
    startWaiting("Plase Wait");
    ajax.send(data, getCircularReplacer());
    stopWaiting();
